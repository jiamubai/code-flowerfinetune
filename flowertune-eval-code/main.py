        ...
        for idx, task in enumerate(task_names):
            ...
            if args.generation_only:
                ...
                if accelerator.is_main_process:
                    ...
                    save_generations_path = f"{args.save_folder}/{os.path.splitext(args.save_generations_path)[0]}_{task}.json"
                    save_references_path = f"{args.save_folder}/references_{task}.json"
